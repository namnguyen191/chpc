...
public class TimeSeries {
    ...
    public void createTimeSeries(JPanel west) {
        org.jfree.data.time.TimeSeries series1 = new org.jfree.data.time.TimeSeries("city1");
        ...
        org.jfree.data.time.TimeSeries series2 = new org.jfree.data.time.TimeSeries("city2");
        ...
        org.jfree.data.time.TimeSeries series3 = new org.jfree.data.time.TimeSeries("city3");
