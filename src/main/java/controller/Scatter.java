...
public class Scatter implements View{
    ...
    public void createScatter(JPanel west){
        TimeSeries series1 = new TimeSeries("area1");
        ...
        TimeSeries series2 = new TimeSeries("area2");
